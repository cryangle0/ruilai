...
async function loadComponent() {
  return import('../src/components/common/EmptyStateContent.js').catch(() => ({}))
}
...
test('Web shared empty state renders the issue 34 text and accessible icon contract', async () => {
